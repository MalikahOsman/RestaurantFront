 ...
 */
public abstract class RestaurantManager implements Serializable {
    private Long id;
    ...
    public abstract String activateManager(String userName, String password, String empName, String empNum, String address, String telephone, Employee employee);

    public abstract boolean isAccountActivated();

    public abstract boolean deactivateAccount();
