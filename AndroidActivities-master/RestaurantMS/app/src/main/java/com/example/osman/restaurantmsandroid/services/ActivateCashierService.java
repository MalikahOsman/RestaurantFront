 ...
 */
public interface ActivateCashierService {
    String activateCashier(String userName, String password, String empName, String empNum, String address, String telephone, Employee employee);
